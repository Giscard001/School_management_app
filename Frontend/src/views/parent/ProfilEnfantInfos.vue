  ...
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
      <div class="p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
        ...
        <button @click="$emit('edit-info')" class="text-primary text-sm font-medium">Modifier</button>
      </div>
      <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-x-8">
        <div class="flex flex-col gap-1 border-b border-slate-100 dark:border-slate-800 py-4">
          ...
          <p class="text-slate-900 dark:text-white text-sm font-medium">{{ childProfile.birthDate }}</p>
        </div>
        <div class="flex flex-col gap-1 border-b border-slate-100 dark:border-slate-800 py-4">
    ...
    <div>
      <div class="flex justify-between items-end mb-3 px-1">
        ...
        <button class="text-primary text-sm font-medium">Voir tout l'équipe</button>
      </div>
...
defineEmits(['edit-info', 'contact-teacher'])
</script>
